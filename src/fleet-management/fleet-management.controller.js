...
export const listFleetItems = async (c) => {
...
export const getFleetItemById = async (c) => {
...
export const createFleetItem = async (c) => {
    try {
...
export const updateFleetItem = async (c) => {
    const id = c.req.param("id");
    const fleetItem = await c.req.json();
    const parsedFleetItem = fleetManagementSchema.parse({
        ...fleetItem,
...
export const deleteFleetItem = async (c) => {
    const id = c.req.param("id");
